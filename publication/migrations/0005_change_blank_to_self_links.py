...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for pub in orm.Publication.objects.iterator():
            pub.message = pub.message.replace('_blank', '_self')
            pub.save()

    def backwards(self, orm):
        "Write your backwards methods here."
        for pub in orm.Publication.objects.iterator():
            pub.message = pub.message.replace('_self', '_blank')
            pub.save()
    ...
    models = {
        ...
        'publication.publication': {
            ...
            'theme': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'publications'", 'to': "orm['publication.Theme']"}),
